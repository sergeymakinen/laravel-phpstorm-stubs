 ...
 *
 * @method \Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder orWhere(string|\Closure $column, string $operator = null, mixed $value = null) Add an "or where" clause to the query.
